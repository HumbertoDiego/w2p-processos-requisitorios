...
def pop(**kargs):
    ...
    cur.execute("INSERT INTO secao (id_pai, nm_sigla, in_excluido) VALUES (%s,%s,%s).", (id_secao_pai,"Aquisições","n"))
    ...
    cur2 = con.cursor()
    cur2.execute("INSERT INTO configuracoes (contas_salc) VALUES (%s)", (id_usuario))
    con2.commit()
